...
PREV_WEZTERM_THEME=$CATPPUCCIN_LATTE_3
NEXT_WEZTERM_THEME=$CATPPUCCIN_MOCHA_3
...
if $DARK_MODE; then
  ...
  PREV_WEZTERM_THEME=$CATPPUCCIN_MOCHA_3
  NEXT_WEZTERM_THEME=$CATPPUCCIN_LATTE_3
...
sed -i -e "s/$PREV_WEZTERM_THEME/$NEXT_WEZTERM_THEME/" $HOME/.config/wezterm/wezterm.lua
# change yazi theme
