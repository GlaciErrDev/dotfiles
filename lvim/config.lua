...
lvim.keys.normal_mode["<leader>m"] = ":BufferLineCyclePrev<CR>"
...
lvim.keys.normal_mode["<space>q"] = ":q<cr>" -- or vim.keymap.set("n", "<C-q>", ":q<cr>" )

-- VISUAL MODE
lvim.keys.visual_mode["<leader>st"] = "<cmd>Telescope grep_string<CR>"
